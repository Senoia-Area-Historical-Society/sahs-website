      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <nav aria-label="Main Desktop Navigation" className="hidden md:flex space-x-4 lg:space-x-8 h-full items-center">
            ...
            >
              ...
              {activeDropdown === 'visit' && (
                ...
                >
                  ...
                  <Link to="/historic-structures-and-places" role="menuitem" className="block px-6 py-3 text-sm text-charcoal hover:bg-cream hover:text-tan transition-all">Historic Locations</Link>
            ...
            <Link to="/senoia-stories" className="text-charcoal hover:text-tan transition-colors px-3 py-2 text-sm font-medium uppercase tracking-wider">Projects</Link>
          ...
          <nav aria-label="Mobile Navigation" className="flex-1 overflow-y-auto space-y-6">
            <div className="space-y-3">
              ...
              <div className="space-y-1">
                ...
                <Link to="/historic-structures-and-places" className="block px-4 py-3 text-lg text-charcoal hover:bg-tan/5 rounded-lg transition-colors">Historic Locations</Link>
            ...
            <div className="space-y-3">
              <h3 className="text-xs font-bold uppercase tracking-widest text-tan/60 px-2">Projects</h3>
              <div className="space-y-1">
                <Link to="/senoia-stories" className="block px-4 py-3 text-lg font-bold text-tan-dark hover:bg-tan/5 rounded-lg transition-colors">Senoia Stories Project</Link>
              </div>
            </div>
